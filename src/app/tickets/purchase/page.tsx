...
const TICKET_PRODUCTS = [
  { id: 'prod1', name: '55분 수업 4회권 (100,000원)' },
  { id: 'prod2', name: '55분 수업 8회권 (180,000원)' },
  { id: 'prod3', name: '115분 수업 4회권 (180,000원)' },
  { id: 'prod4', name: '115분 수업 8회권 (320,000원)' },
];
...
export default function PurchasePage() {
  ...
  const [pProduct, setPProduct] = useState(TICKET_PRODUCTS[0].name);
          ...
          {!purchaseSuccess ? (
            <form onSubmit={handlePurchaseSubmit}>
              ...
              <button
                ...
                disabled={purchaseLoading || !pRealName.trim() || !pNickname.trim() || !pPhone.trim() || !pDepositor.trim()}
              >
