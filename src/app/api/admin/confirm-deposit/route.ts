...
export async function GET(request: Request) {
  ...
  if (SOLAPI_API_KEY && SOLAPI_API_SECRET && SOLAPI_SENDER_NUMBER && SOLAPI_PF_ID && SOLAPI_TEMPLATE_ID_CONFIRM) {
    try {
...
function renderAuthHtml(realName: string, productName: string, price: string, isError: boolean) {
  return `
    ...
    <html lang="ko">
      ...
      <body>
        <div class="card">
          <div class="title">입금 확인 요청 승인</div>
          <div class="info-box">
            <div class="info-row">
